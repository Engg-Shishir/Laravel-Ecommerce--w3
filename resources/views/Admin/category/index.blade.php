            ...
            <table id="datatable1" class="table display responsive nowrap table-vordered table-hover">
              ...
              <tbody>
                ...
                <tr class="text-center">
                  ...
                  <td>
                  <a href="{{url('/category/delete/'.$category->id)}}" class="btn btn-danger btn-sm"><i class="fas fa-trash text-light"></i></a>
                    <a href="{{url('/category/edit/'.$category->id)}}" class="btn btn-warning btn-sm"><i class="fas fa-edit text-light"></i></a>
                    <!--======== Check category status =========-->
                    @if($category->status == 1)
                    <a href="{{url('/category/status/'.$category->id.'/'.$category->status)}}" class="btn btn-sm"><i class="menu-item-icon icon ion-ios-gear-outline tx-24 " style="color: rgb(238, 0, 0) !important;"></i></a>
                    @else
                    <a href="{{url('/category/status/'.$category->id.'/'.$category->status)}}" class="btn btn-sm"><i class="menu-item-icon icon ion-ios-gear-outline tx-24 " style="color: rgb(0, 226, 68) !important;"></i></a>
                    @endif
                  </td>
                </tr>
                @endforeach
